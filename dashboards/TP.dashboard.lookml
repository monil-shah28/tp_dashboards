- dashboard: tp_employee
  ...
  - title: Employee Allocation per BU tree map
    ...
    model: tp
    explore: employee
    type: test_mysql_nikhil::normal_treemap_drill_down
  ...
  - title: LD per BU
    ...
    type: looker_pie
    fields: [jira_business_unit.business_unit, jira_business_unit.count]
    sorts: [jira_business_unit.business_unit]
    limit: 500
    column_limit: 50
    value_labels: legend
    label_type: labPer
